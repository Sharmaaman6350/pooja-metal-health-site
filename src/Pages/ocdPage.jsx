...
import sideImg from "../images/psy_def.jpg"
...
const OCDPage = () => {
  document.title = "OCD Problems Counselling In Jaipur "
  return (
    <>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-8">
              <h1 className='fw-bold text-white '> Obsessive Compulsive Disorder(OCD)</h1>
            </div>
            <div className="col-md-4 pt-3">
              <ol className="breadcrumb " >
                ...
                <li className=" text-white fw-bold" > Obsessive Compulsive Disorder (OCD)</li>
              </ol>
            </div>
          </div>
        </div>
