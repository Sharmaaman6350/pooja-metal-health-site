...
import sideImg from "../images/id.jpg"
...
const IntellectualPage = () => {
    document.title = "Intellectual Disability Counselling Services In Jaipur "
  return (
    <>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-8">
              <h1 className='fw-bold text-white '>Intellectual Disability</h1>
            </div>
            <div className="col-md-4 pt-3">
              <ol className="breadcrumb " >
                ...
                <li className=" text-white fw-bold" >Intellectual Disability</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="left-content pe-3">
                <h2 className='fw-bold mb-4'>Intellectual Disability</h2>
