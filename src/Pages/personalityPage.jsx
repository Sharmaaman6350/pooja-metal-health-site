...
const PersonalityPage = () => {
    document.title = "Personality Disorders "
  return (
    <>
        ...
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-8">
              <h1 className='fw-bold text-white '>Personality Disorders</h1>
            </div>
            <div className="col-md-4 pt-3">
              <ol className="breadcrumb " >
                ...
                <li className=" text-white fw-bold" >Personality Disorders</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              <div className="left-content pe-3">
                <h2 className='fw-bold mb-4'>Personality Disorders</h2>
