...
import sideImg from "../images/add.jpg"
...
const AdjustmentPage = () => {
    document.title = "Adjustment Disorder Counselling Services In Jaipur "
    return (
        <>
                ...
                <div className="container-fluid">
                    <div className="row">
                        <div className="col-md-8">
                            <h1 className='fw-bold text-white '>Adjustment Disorder</h1>
                        </div>
                        <div className="col-md-4 pt-3">
                            <ol className="breadcrumb " >
                                ...
                                <li className=" text-white fw-bold" >Adjustment Disorder</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-md-8">
                            ...
                            <div className="left-content pe-3">
                                <h2 className='fw-bold mb-4'>Adjustment Disorder</h2>
