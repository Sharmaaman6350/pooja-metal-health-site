...
const About = () => {
  ...
  return (
    <>
      ...
      <section className="main-about-section mb-5" >
        <div className="container-fluid">
          <div className="row">
            <div className="col-md-6">
              <div className="aboutText pt-3 pe-3">
                ...
                <Link href="#" className='btn contactBtn mt-3'> Get Appointment</Link>
              </div>
            </div>
            <div className="col-md-6">
            ...
            <div className="col-md-6 ">
              <div className="right-content">
                ...
                <div className="contact-detail ms-5 ">
                  <Link href="#" className='text-white mail '><FontAwesomeIcon icon={faEnvelope} className='me-2' />Sharmapooja403542@gmail.com</Link>
                  <Link href="#" className=' phone '><FontAwesomeIcon icon={faPhone} className='me-2' />+91 9636386305</Link>
                </div>
        ...
        <div className="container-fluid">
          ...
          <div className="row">
            <div className="col-md-7">
              <Link href="#"><img src={whyus} alt="why to choose us" className='' height={400} width={100} /></Link>
            </div>
          ...
          <center><Link href="#" className='btn contactBtn mt-3 mb-5'> Get Appointment</Link></center>
        </div>
      </section>
